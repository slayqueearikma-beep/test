...
final wishlistProvider =
    FutureProvider.autoDispose<List<WishlistItemModel>>((ref) {
  return apiServiceProvider.fetchWishlist();
});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(l10n.emptyWishlist,
                        style: Theme.of(context).textTheme.titleMedium),
                    const SizedBox(height: AppSpacing.sm),
                    Text(
                      l10n.emptyWishlistSubtitle,
...
class _WishlistTile extends ConsumerWidget {
  ...
  Future<void> _remove(BuildContext context, WidgetRef ref) async {
    final l10n = context.l10n;
    try {
      await apiServiceProvider.removeWishlistProduct(item.productId);
