                    ...
                    SliverPadding(
                      ...
                      sliver: SliverLayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          final cardHeight = (isRtl ? 136.0 : 128.0) *
                              textScale.clamp(1.0, 1.35);
                          final profileViews = analytics?.profileViewCount ??
                          ...
                          final contactClicks = analytics?.contactClickCount ??
                              stats.contactClickCount;
                          ...
                          return SliverGrid(
                            ...
                            delegate: SliverChildListDelegate([
                              StatCard(
                                ...
                                trend:
                                    profileViews > 0 ? null : l10n.noViewsYet,
                              ),
                              StatCard(
                                label: l10n.products,
                                value: '$productCount',
            ...
            children: [
              Text(l10n.analytics,
                  style: Theme.of(context)
                      ...
                      ?.copyWith(fontWeight: FontWeight.w700)),
              const SizedBox(height: AppSpacing.md),
              _AnalyticsRow(label: l10n.profileViews, value: '$profileViews'),
