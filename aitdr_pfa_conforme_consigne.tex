...
{\Huge\bfseries\color{titleblue} AITDR - Azure Intelligent Threat Detection \& Response}\\[0.5cm]
{\large\bfseries Plateforme SOC Cloud --- Détection Intelligente et Réponse Automatisée aux Cybermenaces}\\[0.3cm]
...
\textbf{Encadrant} & [Nom du superviseur] \\[4pt]
\textbf{Date} & 16 juin 2026 \\[4pt]
\textbf{Version} & Version 1.0 --- Final \\[4pt]
\textbf{Budget} & Budget : 100 USD \\
\end{tabular}
\vfill
{\color{titleblue}\rule{\textwidth}{0.5pt}}
\end{titlepage}
